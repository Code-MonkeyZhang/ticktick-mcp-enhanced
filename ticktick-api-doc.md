...
Request Body: A JSON array containing task move operations.
...
Request Body: A JSON object containing filter criteria. All fields are optional, but at least one filter is recommended to narrow down results.
